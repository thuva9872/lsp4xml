package org.eclipse.lsp4xml.extensions.definition.pariticipants;
...
import org.eclipse.lsp4xml.extensions.definition.XMLDefinitionManager;
...
public class SynapseReferencesDefinitionParticipant implements IDefinitionParticipant {
    ...
    public void findDefinition(DOMDocument document, Position position, List<Location> locations) {
        ...
        try {
            ...
            if (node != null) {
                XMLDefinitionManager.getInstance().collect(node, n -> {
